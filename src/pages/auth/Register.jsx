    ...
    <section className="bg-gray-50 min-h-screen flex items-center justify-center">
      ...
      <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
        ...
        <div className=" px-8 md:px-10 w-[500px]">
          <h2 className="font-bold text-4xl text-center text-[#002D74]">
            Register
          </h2>
          ...
          <form action="" className="flex flex-col mt-8">
            <label htmlFor="fullname" className="text-[#002D74]">
              Fullname
            </label>
            <input
            ...
            <label htmlFor="confirmPassword" className="text-[#002D74]">
              Confirm Password
            </label>
            <div className="relative">
              <input
